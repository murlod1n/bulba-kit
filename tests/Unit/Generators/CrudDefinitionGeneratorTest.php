...
class CrudDefinitionGeneratorTest extends TestCase
{
    private CrudDefinitionGenerator $generator;
    ...
    {
        parent::setUp();
        $this->generator = new CrudDefinitionGenerator;
    ...
    public function test_generate_creates_resource_file(): void
    {
        ...
        $this->assertFileExists($this->resourceDir.'/PostCrudDefinition.php');
    }
    ...
    public function test_generate_resource_contains_class_name(): void
    {
        ...
        $this->assertFileContains($this->resourceDir.'/PostCrudDefinition.php', 'class PostCrudDefinition extends AbstractCrudDefinition');
    }
    ...
    public function test_generate_resource_contains_model_reference(): void
    {
        ...
        $this->assertFileContains($this->resourceDir.'/PostCrudDefinition.php', 'return Post::class');
    }
    ...
    public function test_generate_resource_contains_field(): void
    {
        ...
        $content = file_get_contents($this->resourceDir.'/PostCrudDefinition.php');
    ...
    public function test_generate_resource_contains_belongs_to_relation(): void
    {
        $fields = [];
    ...
    public function test_generate_resource_contains_has_one_relation(): void
    {
        $fields = [];
        ...
        $content = file_get_contents($this->resourceDir.'/UserCrudDefinition.php');
        $this->assertStringContainsString("'type' => 'hasOne'", $content);
        $this->assertStringContainsString("'foreign_key' => 'user_id'", $content);
    }

    public function test_generate_resource_contains_has_many_relation(): void
    {
        $fields = [];
    ...
    public function test_generate_resource_contains_belongs_to_many_relation(): void
    {
        $fields = [];
    ...
    public function test_generate_resource_contains_fk_field_for_belongs_to(): void
    {
        $fields = [
            ['name' => 'title', 'type' => 'string', 'modifiers' => []],
        ];
    ...
    public function test_generate_resource_with_multiple_fields(): void
    {
        ...
        $content = file_get_contents($this->resourceDir.'/ProductCrudDefinition.php');
        $this->assertStringContainsString("'title'", $content);
    ...
    public function test_add_inverse_relation_injects_has_many_into_existing_resource(): void
    {
...
class UserResource extends AbstractCrudDefinition
{
...
PHP;
        ...
        File::put($this->resourceDir.'/UserCrudDefinition.php', $existingResource);
    ...
    public function test_add_inverse_relation_injects_belongs_to_fk_field(): void
    {
        $existingResource = <<<'PHP'
<?php
...
class CategoryResource extends AbstractCrudDefinition
{
    public static function model(): string
    {
...
PHP;
        ...
        File::put($this->resourceDir.'/CategoryCrudDefinition.php', $existingResource);

        $this->generator->addInverseRelation('Category', 'hasMany', 'Post', 'category_id', 'title');

        $content = file_get_contents($this->resourceDir.'/CategoryCrudDefinition.php');
        $this->assertStringContainsString("'posts'", $content);
        $this->assertStringContainsString("'type' => 'hasMany'", $content);
    }
    ...
    public function test_add_inverse_relation_skips_if_resource_not_exists(): void
    {
        ...
        $this->assertFileDoesNotExist($this->resourceDir.'/NonExistentCrudDefinition.php');
    }
